...
{ 
  int *v; v=(int *)malloc((size_t) ((nh-nl+1+NR_END)*sizeof(int))); 
...
standard C manner as a[nrow][ncol], where nrow=nrh-nrl+1 and ncol=nch-ncl+1. The routine 
